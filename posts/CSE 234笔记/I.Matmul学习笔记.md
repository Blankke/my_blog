...
![[./img/I.Matmul学习笔记-01.png|1000]]
二维的例子，行连续存储`stride[1]`，列每增加1，存储号增加4，`stride[2]`为4.
下面这道题目更加便于理解
![[./img/I.Matmul学习笔记-02.png]]
